  ...
  <div class="page-footer">
				...
				<div class="page-content-coll-one tag-coll">
					...
					<div> 
							...
							<div class="mailes">
								...
								<div class="mail-versus"> info@modu.versus</div>
							</div> 
					</div>
				</div>
	  ...
	  <div class="content">
			<div class="bottom-fotter">
					...
					<nav class="logopicture">
						<div class="facebook"><img src="./page-png/Facebook.png" alt=""></div>
						<div class="google"><img src="./page-png/google.png" alt=""></div>
						<div class="twetter"><img src="./page-png/twetter.png" alt=""></div>
						<div class="rss"><img src="./page-png/rss.png" alt=""></div>
					</nav> 
			</div>
	  </div>	 
	  </content-wrapper>	 
